...
For production-ready cloud deployment instructions using Terraform and Kubernetes (AKS) on Azure (incorporating high availability, private networking, managed PostgreSQL, Entra Workload Identity, Key Vault, and Application Gateway WAF v2), please refer to the [Azure Infrastructure Deployment Guide](../Terraform/README.md).
